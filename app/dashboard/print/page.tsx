	...
	return (
		<>
			<main className="min-h-screen flex w-full">
				<Sidebar onTabClick={handleTabClick} activeTab="Print" />
				<section className="w-full mx-auto print-container">
					<Header />
					<div className="print-header">
						<h1 className="print-title mx-auto font-bold opacity-80 text-center">
							Print your SoulGem!
						</h1>
					...
					<div className="text-center mx-auto mt-56">
                        You will soon be able to print your SoulGems! Stay tuned!
                    </div>
				</section>
			</main>
		</>
