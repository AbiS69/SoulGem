				...
				{loading ? (
					...
					<div className="gallery-images">
						{images.length === 0 ? (
							...
							<>
								<div className="gallery-title">Square Artworks</div>
								...
								<div className="gallery-title">Smartphone Wallpapers</div>
								<div className="gallery-format">
									{images.map(
										(image, index) =>
								...
								<div className="gallery-title">Desktop Wallpapers</div>
								<div className="gallery-format">
									{images.map(
										(image, index) =>
